    ...
    <div class="accordion accordion-flush" id="accordionFlushExample">
      <div class="accordion-item">
        ...
        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
          <div class="accordion-body">Auf Dieser Seite haben Sie eine Übersicht von den erstellten To-Dos. Sie werden je nach Aufgabentyp angezeigt und bringen einige Funktionen mit sich. Dazu gehört das erstellen einer To-Do mit dem Button grünen unten rechts. Außerdem haben Sie die Möglichkeit einzelne To-Dos zu bearbeiten, löschen oder abzuhaken. Falls Sie eine To-Do löschen oder bearbeiten, müssten Sie die Website aktualisieren
            damit die entsprechenden Änderungen angezeigt werden.
